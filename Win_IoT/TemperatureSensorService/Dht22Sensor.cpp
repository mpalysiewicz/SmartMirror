...
using namespace TemperatureSensorService;

_Use_decl_annotations_

Dht22Sensor::Dht22Sensor(Windows::Devices::Gpio::GpioPin^ pin, Windows::Devices::Gpio::GpioPinDriveMode inputReadMode)
{
	// ***
...
Windows::Foundation::IAsyncOperation<TemperatureSensorReading>^ Dht22Sensor::GetReadingAsync()
{
	return this->GetReadingAsync(DEFAULT_MAX_RETRIES);
}

Windows::Foundation::IAsyncOperation<TemperatureSensorReading>^ Dht22Sensor::GetReadingAsync(int maxRetries)
{
	return create_async([this, maxRetries]
	{
		TemperatureSensorReading returnValue;
		int i = 0;
...
TemperatureSensorReading Dht22Sensor::InternalGetReading()
{
	TemperatureSensorReading returnValue;
